...
@Component({
  selector: 'app-participante-indireto-form',
  templateUrl: './participante-indireto-form.component.html',
  styleUrls: ['./participante-indireto-form.component.scss']
})
export class ParticipanteIndiretoFormComponent implements OnInit {
  formData: FormGroup;
  ...
  cadastrarParticipanteIndireto() {
    var indireto = new ParticipanteIndireto();
    ...
    this.ParticipanteIndiretoService.salvarParticipanteIndireto(indireto).subscribe(() =>{
