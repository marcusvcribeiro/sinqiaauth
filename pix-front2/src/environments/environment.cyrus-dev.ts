...
export const environment = {
  ...
  sistema: 'SQPIX',
  api: {
    ui: 'https://dev.sinqia.io/core-ui-manager-server/api/v2/',
    core: 'https://dev.sinqia.io/api-bancos-pix-core/v1',
    //core: 'http://localhost:8781/v1',
    pix_mock: 'http://localhost:8399/api/v1',
    pix: 'https://devl5.sinqia.io/api-bancos-pix-ws/api/v1',
    seg: 'https://dev.sinqia.io/api-bancos-seg-core',
    //seg: "http://localhost:5000",
    relatorios: 'https://dev.sinqia.io/bancos-spi-relatorios/api/v1',
    cob: 'https://dev.sinqia.io/api-bancos-gcob-core/api'
  },
...
environment.authConfig.stsServer = 'https://dev.sinqia.io/auth/realms/sinqia';
