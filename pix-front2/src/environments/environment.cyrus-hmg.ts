...
export const environment = {
  ...
  sistema: 'SQPIX',
  api: {
    ui: 'https://hmg.sinqia.io/core-ui-manager-server/api/v1/',
    core: 'https://hmg.sinqia.io/api-bancos-pix-core/v1',
    pix_mock: 'http://localhost:8399/api/v1',
    pix: 'https://hmgl5.sinqia.io/api-bancos-pix-ws/api/v1',
    seg:'https://hmg.sinqia.io/api-bancos-seg-core/api',
    relatorios:'https://hmg.sinqia.io/bancos-spi-relatorios/api/v1',
    cob:'https://hmg.sinqia.io/api-bancos-gcob-core/api'
  },
...
environment.authConfig.stsServer = 'https://hmg.sinqia.io/auth/realms/sinqia';
