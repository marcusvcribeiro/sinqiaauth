...
import { DefinirPrioridadeComponent } from '../../definir-prioridade/definir-prioridade.component';
...
@Component({
  selector: 'app-boletagem-lista',
  templateUrl: './boletagem-lista.component.html',
  styleUrls: ['./boletagem-lista.component.scss']
})
export class BoletagemListaComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @Input() exibirDetalhes: boolean = false;

  condicaoTipo: Campo;
  public ds: SinqiaDataSource<BoletagemConsulta>;
  filtroForm: FormGroup;
  listResult: ListResult<BoletagemConsulta>;
  checkbox = new SelectionModel<BoletagemConsulta>(true, []);
  ...
  criarDataSource() {
    this.ds = SinqiaDataSource.of<BoletagemConsulta>()
  ...
  criarFiltroTabela() {
    ...
    const filtroEntrada = new BoletagemConsultaFiltro({ ...this.filtro, situacaoTransacao: this.tipoBoletagem });
    ...
    this.filtroForm = this.formBuilder.group({
      ...
      cpfCnpjRecebedor: [filtroEntrada.cpfCnpjRecebedor],
      cpfCnpjPagador: [filtroEntrada.cpfCnpjPagador],
      nomePagador: [filtroEntrada.nomePagador], 
    });
    if (this.isModelo) {
