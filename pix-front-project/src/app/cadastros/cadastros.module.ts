...
import { ListaAlcadaGrupoComponent } from './components/composicao-grp-usuario/lista-alcada-grupo/lista-alcada-grupo.component';
import { ListaAlarmeGrupoComponent } from './components/composicao-grp-usuario/lista-alarme-grupo/lista-alarme-grupo.component';

@NgModule({
  declarations: [
    ListaGruposUsuariosComponent,
    ListaAlcadaGrupoComponent,
    ListaAlarmeGrupoComponent,
