...
export class BoletoComponent implements OnInit {
  ...
  criarForm() {
    ...
    this.form = this.formBuilder.group({
      ...
      dataMovimento: null,
      canalMensagem: [1, Validators.required],
    });
  ...
  private criarBoletoPayload(): BoletoPayload {
    ...
    const {dataMovimento, nomeModelo, situacao, canalMensagem} = this.form.getRawValue();

    boletoPayload.dataMovimento = dataMovimento;
    boletoPayload.nomeModeloMensagem = nomeModelo;
    boletoPayload.idCanalMensagem = canalMensagem;
